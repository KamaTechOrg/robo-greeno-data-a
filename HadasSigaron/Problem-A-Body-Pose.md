...
you have to think clearly about two reference frames — the world
(where the feet really are) and the body frame (where the inverse
kinematics does its work). It is also a real capability: keeping the
body level while the feet sit on uneven ground is exactly this maths.
...
**Where this leads:** body-pose control is exactly what the Stage B
gait work and the later uneven-terrain work are built on. A student
who finishes this has built a real piece of the robot.
